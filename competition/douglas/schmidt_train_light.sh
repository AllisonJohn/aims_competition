...
#   sbatch competition/douglas/schmidt_train_light.sh --latent-dim 8 --learning-rate 3e-4 --irt-l2 1e-5 --temperature 0.7 --weight-decay 1e-5 --item-head-hidden-dim 64
