...
#   sbatch competition/douglas/schmidt_train_light_bge_large.sh
# Forward training flags after the script name, for example:
#   sbatch competition/douglas/schmidt_train_light_bge_large.sh --learning-rate 3e-4 --irt-l2 1e-3 --temperature 0.7 --weight-decay 1e-4 --item-head-hidden-dim 64

#SBATCH --job-name=douglas-light-bge-large
...
"$RUN_PYTHON" competition/douglas/training_light.py --item-encoder bge-large "$@"
