...
This script trains the same artifact family as ``modal_train_final_bge_ridge_bagging.py``
...
Run:
    modal run competition/douglas_ridge_bagging/modal_validate_bge_ridge_bagging.py
"""
...
APP_NAME = "douglas-ridge-bagging-validation"
...
image = (
    ...
    .add_local_dir(LOCAL_RIDGE_DIR, remote_path="/root/competition/douglas_ridge_bagging")
)
...
def validate_remote(
    ...
    remote_submission_dir = Path("/root/competition/douglas_ridge_bagging")
...
def main(
    ...
    summary_path = LOCAL_ARTIFACT_DIR / "validation_80_20_bagging_summary.json"
