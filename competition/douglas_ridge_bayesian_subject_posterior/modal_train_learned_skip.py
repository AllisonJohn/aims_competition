...
app = modal.App("cs321m-final-bge-bayesian-subject-posterior-artifact")
...
def train_remote(
    ...
    posterior_prior_precision: float = 1.5,
    posterior_max_steps: int = 8,
    posterior_max_labels: int = 32,
) -> dict:
    import math
    ...
    return {
        "artifact": {
            ...
            "posterior_prior_precision": float(posterior_prior_precision),
            "posterior_max_steps": int(posterior_max_steps),
            "posterior_max_labels": int(posterior_max_labels),
            "prior_weights": {
...
def main(
    ...
    payload = train_remote.remote(
        ...
        posterior_prior_precision,
        posterior_max_steps,
        posterior_max_labels,
    )
