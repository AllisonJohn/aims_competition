...
def _calibrate_with_labeled(prediction: float, input: dict, labeled: list[dict] | None) -> float:
    ...
    category_delta = bayes_delta(category_labels, category_expected, 9.0, CATEGORY_DELTA_CAP)
    subject_delta = bayes_delta(subject_labels, subject_expected, 7.0, SUBJECT_DELTA_CAP)
