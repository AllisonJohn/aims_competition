...
def acquisition_function(input: dict) -> float:
    ...
    score = 0.42 * uncertainty + _complexity(input.get("item_content"))
    score -= 0.090 * _SEEN_CATEGORIES[category]
    score -= 0.055 * _SEEN_SUBJECTS[subject]
    score -= 0.025 * _SEEN_CONDITIONS[condition]
    score -= 0.060 * _SEEN_BUCKETS[bucket]
