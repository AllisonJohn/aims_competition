...
def acquisition_function(input: dict) -> float:
    ...
    score = 0.62 * uncertainty + _complexity(input.get("item_content"))
    score -= 0.060 * _SEEN_CATEGORIES[category]
    score -= 0.035 * _SEEN_SUBJECTS[subject]
    score -= 0.018 * _SEEN_CONDITIONS[condition]
    score -= 0.045 * _SEEN_BUCKETS[bucket]
