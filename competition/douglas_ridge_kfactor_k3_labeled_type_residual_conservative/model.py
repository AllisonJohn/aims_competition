...
CATEGORY_DELTA_CAP = 0.12
SUBJECT_DELTA_CAP = 0.10
SUBJECT_FACTORS = {
...
def _calibrate_with_labeled(prediction: float, input: dict, labeled: list[dict] | None) -> float:
    ...
    category_delta = bayes_delta(category_labels, category_expected, 10.0, CATEGORY_DELTA_CAP)
    subject_delta = bayes_delta(subject_labels, subject_expected, 8.0, SUBJECT_DELTA_CAP)
