...
CATEGORY_DELTA_CAP = 0.22
SUBJECT_DELTA_CAP = 0.20
SUBJECT_FACTORS = {
...
def _calibrate_with_labeled(prediction: float, input: dict, labeled: list[dict] | None) -> float:
    ...
    category_delta = bayes_delta(category_labels, category_expected, 6.0, CATEGORY_DELTA_CAP)
    subject_delta = bayes_delta(subject_labels, subject_expected, 4.0, SUBJECT_DELTA_CAP)
    total_delta = benchmark_delta + 0.80 * category_delta + 0.60 * subject_delta
