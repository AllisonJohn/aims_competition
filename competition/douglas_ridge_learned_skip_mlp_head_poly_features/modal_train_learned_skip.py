...
app = modal.App("cs321m-final-bge-learned-skip-mlp-head-poly-features")
    ...
    for row in train_df.itertuples(index=False):
        ...
        calibration_rows.append(
            [
                ...
                signed_sqrt(subject_logit),
                signed_sqrt(condition_logit),
                signed_sqrt(benchmark_logit),
                signed_sqrt(adjustment),
                signed_sqrt(difficulty),
                signed_log1p(subject_logit),
                signed_log1p(condition_logit),
                signed_log1p(benchmark_logit),
                signed_log1p(adjustment),
                signed_log1p(difficulty),
        ...
        "artifact": {
            ...
            "calibrator": {
                "feature_names": [
                    ...
                    "item_adjustment_sq",
                    "difficulty_sq",
                    "signed_sqrt_subject_logit",
                    "signed_sqrt_condition_logit",
                    "signed_sqrt_benchmark_logit",
                    "signed_sqrt_item_adjustment",
                    "signed_sqrt_difficulty",
                    "signed_log1p_subject_logit",
                    "signed_log1p_condition_logit",
                    "signed_log1p_benchmark_logit",
                    "signed_log1p_item_adjustment",
                    "signed_log1p_difficulty",
                    "subject_x_difficulty",
                    "condition_x_difficulty",
                    "benchmark_x_difficulty",
                    "item_adjustment_x_difficulty",
                    "abs_difficulty",
                ],
