...
def _calibrator_features(input: dict, difficulty: float) -> list[float]:
    ...
    return [
        ...
        _signed_sqrt(subject_logit),
        _signed_sqrt(condition_logit),
        _signed_sqrt(benchmark_logit),
        _signed_sqrt(adjustment),
        _signed_sqrt(difficulty),
        _signed_log1p(subject_logit),
        _signed_log1p(condition_logit),
        _signed_log1p(benchmark_logit),
        _signed_log1p(adjustment),
        _signed_log1p(difficulty),
