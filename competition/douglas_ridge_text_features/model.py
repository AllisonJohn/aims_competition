"""Handcrafted text features + centered IRT difficulty correction submission.

Base predictor: smoothed subject/condition baseline.
Text correction: 73 deterministic item text features -> centered IRT item
difficulty ridge model.
"""
...
FEATURE_DIM = int(ARTIFACT.get("feature_dim", 73))
