...
app = modal.App("aims-label-weighted-rate-bayes-sweep")
...
def tune_remote(
    ...
    grid = []
    for weight_mode in ("uniform", "uncertainty_soft", "uncertainty_strong", "middle", "confidence_soft"):
    ...
    for config in grid:
        ...
        print(
            ...
            f"cond={config['cond_weight']} subj={config['subj_weight']} "
...
def main(
    ...
    json_out: str | None = "label_validation_sandbox/weighted_rate_bayes_sweep.json",
) -> None:
