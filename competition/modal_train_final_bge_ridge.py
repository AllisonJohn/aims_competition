...
app = modal.App("cs321m-final-bge-ridge-artifact")
...
def main(
    ...
    stats_path = root / "submission3" / "artifacts" / "baseline_stats.json"
    out_dir = root / "submission8" / "artifacts"
    out_dir.mkdir(parents=True, exist_ok=True)
    stats = json.loads(stats_path.read_text(encoding="utf-8"))
    payload = train_remote.remote(stats, train_rows, item_limit, encoder_id)
